...
//     return [
//         { title: "BuildXo - AI-Powered 3D Floor Plan Rendering" },
...
//                             Join thousands of professionals who have accelerated their design process with BuildXo
//                         </p>
//                     </div>
//
//                     <div className="grid md:grid-cols-3 gap-8">
...
//                                     "BuildXo has completely transformed our workflow. We can now generate photorealistic renders in seconds instead of hours."
//                                 </p>
...
export function meta({}: Route.MetaArgs) {
    return [
        ...
        {
            name: "description",
            content: "Transform 2D floor plans into photorealistic 3D renders instantly using next-gen generative AI. Experience the future of architectural visualization."
        },
    ];
}
...
export default function Home() {
    ...
    // --- TESTIMONIAL DATA (fixed) ---
    const testimonials = [
        {
            name: "John Williams",
            role: "Architect at Studio Globe NYC",
            message: "BuildXo has completely transformed our workflow. We can now generate photorealistic renders in seconds instead of hours.",
            initial: "J"
        },
        {
            name: "Sarah Johnson",
            role: "Interior Designer at ModernSpace",
            message: "The AI rendering quality is outstanding. Our clients instantly understand the vision.",
            initial: "S"
        },
        {
            name: "Michael Chen",
            role: "Lead Architect at UrbanForm",
            message: "What used to take our team hours now takes seconds. BuildXo changed our workflow.",
            initial: "M"
        }
    ];
    ...
    return (
        <div className="relative min-h-screen bg-[#050505] text-white overflow-x-hidden font-sans antialiased">
            ...
            <div
                className="fixed inset-0 bg-[radial-gradient(ellipse_at_top,_rgba(59,130,246,0.1),_transparent_50%),_radial-gradient(ellipse_at_bottom,_rgba(139,92,246,0.05),_transparent_50%)]"/>
            <div
                className="fixed inset-0 opacity-20"
                style={{
                    backgroundImage: `url("data:image/svg+xml,%3Csvg width='100' height='100' viewBox='0 0 100 100' xmlns='http://www.w3.org/2000/svg'%3E%3Cdefs%3E%3Cpattern id='grid' width='100' height='100' patternUnits='userSpaceOnUse'%3E%3Cpath d='M 100 0 L 0 0 0 100' fill='none' stroke='rgba(255,255,255,0.05)' stroke-width='1'/%3E%3C/pattern%3E%3C/defs%3E%3Crect width='100%25' height='100%25' fill='url(%23grid)'/%3E%3C/svg%3E")`
            ...
            <div
                className="fixed top-1/4 left-1/4 w-[800px] h-[800px] bg-blue-600/5 rounded-full blur-[120px] animate-pulse-slow"/>
            <div
                className="fixed bottom-1/4 right-1/4 w-[800px] h-[800px] bg-purple-600/5 rounded-full blur-[120px] animate-pulse-slower"/>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-20">
                        ...
                        <p
                            className={`text-lg sm:text-xl text-white/60 max-w-3xl mx-auto mb-12 leading-relaxed transition-all duration-700 delay-100 ${isVisible.hero ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
                        >
                            Transform 2D floor plans into photorealistic 3D renders instantly using next-gen generative
                            AI. Experience the future of architectural visualization.
                        </p>
                        ...
                        >
                            <div className="text-center group">
                                <div
                                    className="text-3xl md:text-4xl font-bold text-white mb-2 bg-gradient-to-r from-white to-white/80 bg-clip-text text-transparent">10K+
                                </div>
                                <div
                                    className="text-sm text-white/40 group-hover:text-white/60 transition-colors">Projects
                                    Generated
                                </div>
                            </div>
                            <div className="w-px h-12 bg-gradient-to-b from-transparent via-white/20 to-transparent"/>
                            <div className="text-center group">
                                <div
                                    className="text-3xl md:text-4xl font-bold text-white mb-2 bg-gradient-to-r from-white to-white/80 bg-clip-text text-transparent">2.5s
                                </div>
                                <div className="text-sm text-white/40 group-hover:text-white/60 transition-colors">Avg.
                                    Generation
                                </div>
                            </div>
                            <div className="w-px h-12 bg-gradient-to-b from-transparent via-white/20 to-transparent"/>
                            <div className="text-center group">
                                <div
                                    className="text-3xl md:text-4xl font-bold text-white mb-2 bg-gradient-to-r from-white to-white/80 bg-clip-text text-transparent">98%
                                </div>
                                <div
                                    className="text-sm text-white/40 group-hover:text-white/60 transition-colors">Satisfaction
                                </div>
                            </div>
                        </div>
                        ...
                        >
                            <div
                                className="absolute -inset-1 bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 rounded-[2.5rem] opacity-20 group-hover:opacity-40 transition duration-1000 blur-2xl group-hover:blur-3xl"/>
                            <div
                                className="relative bg-[#0a0a0a]/40 border border-white/10 rounded-[2rem] p-1.5 backdrop-blur-3xl shadow-premium overflow-hidden">
                                <div
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="grid md:grid-cols-3 gap-8">
                        {[{
                            ...
                            >
                                <div
                                    className="absolute -inset-0.5 bg-gradient-to-r from-blue-500 to-purple-600 rounded-2xl opacity-0 group-hover:opacity-100 transition duration-500 blur"/>
                                <div
                                    className="relative bg-[#14141A] border border-white/10 rounded-2xl p-8 hover:-translate-y-1 transition-all duration-300">
                                    <div
                                        className="w-12 h-12 bg-gradient-to-br from-blue-500/20 to-purple-600/20 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                                        <feature.icon className="w-6 h-6 text-purple-400"/>
                                    </div>
                                    <h3 className="text-xl font-semibold text-white mb-3">{feature.title}</h3>
                                    <p className="text-white/40 leading-relaxed">{feature.description}</p>
            ...
            <section className="py-32 px-4 sm:px-6 lg:px-8 relative z-10 border-t border-white/5">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-20">
                        ...
                        <p className="text-white/40 text-lg max-w-2xl mx-auto">
                            Access your previously generated AI designs instantly
                        </p>
                    </div>
                    ...
                    {projects.length === 0 ? (
                        ...
                        <div className="grid md:grid-cols-3 gap-8">
                            {projects.map((project) => {
                                const isCompleted = project.timestamp % 2 === 0;

                                return (
                                    <div
                                        key={project.id}
                                        className={`group relative bg-[#0a0a0a]/40 border border-white/10 rounded-[2rem] p-6 transition-all duration-500 backdrop-blur-3xl cursor-pointer 
                hover:bg-[#0a0a0a]/60 hover:border-blue-500/30
                ${isCompleted ? 'hover:shadow-2xl hover:shadow-blue-500/30' : 'cursor-default'}`}
                                        onClick={() => {
                                            if (isCompleted) {
                                                navigate(`/visualizer/${project.id}`, {
                                                    state: { forceRegenerate: true } // forces 3D regeneration
                                                });
                                            }
                                        }}
                                    >
                  ...
                  <span
                      className={`w-3 h-3 rounded-full ${
                          isCompleted
                              ? 'bg-green-500 animate-pulse-fast'
                              : 'bg-yellow-400 animate-bounce-fast'
                      }`}
                  />
    ...
    .animate-bounce-fast { animation: bounce-fast 0.8s infinite; }
  `}</style>
            </section>
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        {testimonials.map((item, i) => (
                            ...
                            >
                                <div
                                    className="absolute inset-0 bg-gradient-to-br from-white/[0.02] to-transparent pointer-events-none rounded-[2rem]"/>
                                <div className="flex items-center gap-1 mb-6">
                                    {[...Array(5)].map((_, j) => (
                                        <Star key={j} className="w-5 h-5 fill-blue-500 text-blue-500"/>
                                    ))}
                                </div>
                                <p className="text-white/60 mb-8 leading-relaxed text-lg italic">
                                    "{item.message}"
                                </p>
                                <div className="flex items-center gap-4">
                                    <div
                                        className="w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-500 to-purple-600 p-[1px]">
                                        <div
                                            className="w-full h-full bg-[#0a0a0a] rounded-[15px] flex items-center justify-center text-white font-bold text-lg">
                                            {item.initial}
                                        </div>
                                    </div>
                                    <div>
            ...
            <style>{`
                ...
                .animate-pulse-slower { animation: pulse-slower 8s infinite; }
